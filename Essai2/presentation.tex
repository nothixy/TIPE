...
\begin{frame}[allowframebreaks]{shortestpath.c}
    \lstinputlisting[language=C, firstline=165, lastline=199]{shortestpath.c} 
\end{frame}
...
\begin{frame}[allowframebreaks]{kavg.c}
    \lstinputlisting[language=C, firstline=250, lastline=298]{kavg.c} 
\end{frame}
\begin{frame}[allowframebreaks]{graph.py}
    \lstinputlisting[language=Python, firstline=58, lastline=71]{graph.py} 
\end{frame}
\end{document}